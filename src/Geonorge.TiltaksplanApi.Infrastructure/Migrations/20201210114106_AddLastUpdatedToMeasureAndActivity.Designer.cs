...
namespace Geonorge.TiltaksplanApi.Infrastructure.Migrations
{
    ...
    [Migration("20201210114106_AddLastUpdatedToMeasureAndActivity")]
    partial class AddLastUpdatedToMeasureAndActivity
    {
            ...
            modelBuilder.Entity("Geonorge.TiltaksplanApi.Domain.Models.Activity", b =>
                {
                    ...
                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 12, 10, 12, 41, 6, 200, DateTimeKind.Local).AddTicks(5910));
            ...
            modelBuilder.Entity("Geonorge.TiltaksplanApi.Domain.Models.Measure", b =>
                {
                    ...
                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 12, 10, 12, 41, 6, 155, DateTimeKind.Local).AddTicks(4726));
