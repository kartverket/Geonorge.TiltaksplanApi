...
namespace Geonorge.TiltaksplanApi.Infrastructure.Migrations
{
    ...
    [Migration("20210115082615_AddInfoUrlToMeasure")]
    partial class AddInfoUrlToMeasure
    {
            ...
            modelBuilder.Entity("Geonorge.TiltaksplanApi.Domain.Models.Activity", b =>
                {
                    ...
                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 1, 15, 9, 26, 15, 82, DateTimeKind.Local).AddTicks(6774));
            ...
            modelBuilder.Entity("Geonorge.TiltaksplanApi.Domain.Models.Measure", b =>
                {
                    ...
                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 1, 15, 9, 26, 15, 38, DateTimeKind.Local).AddTicks(142));
